...
public class TypeWriter : MonoBehaviour
{
    ...
    // New boolean to track completion
    [SerializeField] public bool isFinished { get; private set; } = false;
    ...
    private void StartTypewriter()
    {
        ...
        // Reset isFinished when starting a new typewriter effect
        isFinished = false;
    ...
    IEnumerator TypeWriterText()
    {
        ...
        // Mark as finished and log
        isFinished = true;
        Debug.Log("TypeWriterText: Typing is complete! isFinished = " + isFinished);
    }
    ...
    IEnumerator TypeWriterTMP()
    {
        ...
        // Mark as finished and log
        isFinished = true;
        Debug.Log("TypeWriterTMP: Typing is complete! isFinished = " + isFinished);
    }
}
